...
const MapView: FC<MapViewProps> = ({ markers = [] }) => {
  ...
  const handlePreviewVenue = (venue: {
    latitude: number;
    longitude: number;
  }) => {
    setTempMarker({ latitude: venue.latitude, longitude: venue.longitude });
        ...
        >
          {markers.map((marker, index) => (
            ...
            >
              ...
              >
                ...
                {showVenueNames && (
                  <span> {marker.venue_name || "Unknown"}</span>
                )}
              </div>
            </Marker>
          ))}
          {tempMarker && (
            <Marker
              ...
              anchor="bottom"
            >
              <div className="relative flex flex-col items-center justify-center group z-50">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] sm:text-xs text-white/70 -mt-0.5">
                    Find great coffee near you (at a somewhat reasonable price)
                  </p>
                </div>
              </div>
            </div>
